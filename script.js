const localStorageKey = 'to-do-list-Dudinha'

function validityIfExistsNewTask()
{
...
function newTask()
{
    ...
    else if(validityIfExistsNewTask())
    {
...
function showValues()
{
    ...
    {
        list.innerHTML += `<li>${values[i]['name']}<button id='btn-ok' onclick='removeItem'>ok</button><li>`
    }
}
